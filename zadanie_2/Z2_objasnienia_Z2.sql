...
** do plików na wyznaczonym katalogu
** bk_all_db musi korzystać z bk_db i przekazywać jej nazwę bazy i nazwę katalogu
...
SET @db = N'PWX_DB'
SET @path = N'C:\temp'  -- powinien sie onczyc na \ a nie konczy sie
...
IF @path NOT LIKE N'%\' -- nie ma \  na końcu
	SET @path = @path + N'\'
