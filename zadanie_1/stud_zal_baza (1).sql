...
insert into osoby (imie, nazwisko, id_miasta) values ('Kr?l', 'Neptun', @id_sop)
set @id_kn = SCOPE_IDENTITY()

insert into osoby (imie, nazwisko, id_miasta) values ('Ju?', 'Niepracuj?cy', @id_wwa)
...
select woj.kod_woj, woj.nazwa
from woj join dbo.miasta m on woj.kod_woj = m.kod_woj